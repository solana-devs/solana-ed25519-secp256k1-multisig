...
pub fn verify_secp256k1_ix(
    ...
    {
        return Err(crate::ErrorCodeMultiSig::SigVerificationFailed.into()); // Otherwise, we can already throw err
    }
...
pub fn check_secp256k1_data(
    ...
    {
        return Err(crate::ErrorCodeMultiSig::SigVerificationFailed.into());
    }
